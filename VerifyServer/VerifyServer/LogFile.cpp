...
CLogFile::CLogFile(mystring csFileName)
...
int CLogFile::WriteLog(const mystring csLog)
{
	int nret = -1;
...
int CLogFile::IntervalWriteLog(const mystring csLog, time_t nIntervalTime)
{
	int nret = -1;
...
int CLogFile::_WriteLog(const mychar *pszFmt,va_list argp)
{
	int nret = -1;
...
int CLogFile::WriteLog(const mychar *pszFmt,...)
{
	int nret = -1;
