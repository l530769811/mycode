#ifndef  __WISERVICE_SERVICE_LOGFILE_H__
#define  __WISERVICE_SERVICE_LOGFILE_H__
...
#define LOG_FILE_NAME _T("service_log.txt")
#define LOG_FILE_FOLDER _T("log")
class CServiceLogFile
{
public:
	CServiceLogFile(mystring csFileName);
	CServiceLogFile();
	~CServiceLogFile(void);
...
#endif // end __WISERVICE_SERVICE_LOGFILE_H__
